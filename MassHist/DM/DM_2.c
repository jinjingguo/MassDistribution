...
void test4()
{
  ...
  for(Long64_t jentry=0; jentry<nevents; jentry++)
  {
    ...
    {
        if (tree.trigHLT()[0]==true&&tree.evtSel()[0]==true&&tree.softMuon1()[iCand]==true&&tree.softMuon2()[iCand]==true&&tree.Ntrkoffline()>185&&tree.Ntrkoffline()<250&&tree.mass()[iCand]>2.2&&tree.mass()[iCand]<4.2&&abs(tree.y()[iCand])>1.4&&abs(tree.y()[iCand])<2.4)
            {
