...
void HM_4()
{
  const auto& inputFile = "/storage1/users/ags9/pPb2016/Charmonia/VertexCompositeTree_PAHighMultiplicity_PARun2016C_Charmonia.root";  
  ...
  for(Long64_t jentry=0; jentry<nevents; jentry++)
  {
    ...
    {
       double rapidity = 0;
       if (tree.RunNb() >= 285410 && tree.RunNb() <= 285951)  { rapidity = -tree.y()[iCand]; }
       else if (tree.RunNb() >= 285952 && tree.RunNb() <= 286504) { rapidity = tree.y()[iCand]; } 
       if (tree.trigHLT()[4]==true&&tree.PFMuon1()[iCand]==true&&tree.PFMuon2()[iCand]==true&&tree.Ntrkoffline()>185&&tree.Ntrkoffline()<250&&rapidity>-2.4&&rapidity<-1.4)
            {
