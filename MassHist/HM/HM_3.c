...
void HM_3()
{
  ...
  for(Long64_t jentry=0; jentry<nevents; jentry++)
  {
    ...
    for(uint iCand=0; iCand<tree.candSize(); iCand++)
    {
       ...
       if (tree.trigHLT()[4]==true&&tree.PFMuon1()[iCand]==true&&tree.PFMuon2()[iCand]==true&&tree.Ntrkoffline()>185&&tree.Ntrkoffline()<250&&rapidity>-1.4&&rapidity<0)
            {
