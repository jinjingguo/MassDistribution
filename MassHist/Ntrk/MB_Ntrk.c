...
void MB_Ntrk()
{
  const auto& inputFile = "/storage1/users/ags9/pPb2016/Charmonia/VertexCompositeTree_PAMinimumBias_PARun2016C_Charmonia.root";
  ...
  for(Long64_t jentry=0; jentry<nevents; jentry++)
  {
    ...
    {
        if (tree.trigHLT()[6]==true&&tree.PFMuon1()[iCand]==true&&tree.PFMuon2()[iCand]==true&&tree.y()[iCand]>1.4&&tree.y()[iCand]<2.4&&tree.pT()[iCand]>0.2&&tree.pT()[iCand]<1.8)
            {
