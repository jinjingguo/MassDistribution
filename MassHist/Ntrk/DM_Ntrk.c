...
void DM_Ntrk()
{
  ...
  for(Long64_t jentry=0; jentry<nevents; jentry++)
  {
    ...
    {
        if (tree.trigHLT()[0]==true&&tree.PFMuon1()[iCand]==true&&tree.PFMuon2()[iCand]==true&&abs(tree.y()[iCand])<2.4&&tree.pT()[iCand]>0.2&&tree.pT()[iCand]<1.8)
            {
