...
void getRatio(const char* inputFile1, const char* inputFile2, const char* inputFile3, const char* inputFile4, const char* title, const char* outputFile, int n1, double x1Bin[], int n2, double x2Bin[]){
  ...
  canvas->BuildLegend(0.7,0.7,0.9,0.9,"y_range");
...
void DrawEffRatio(){
  const char* inputFile1 = "./rootFile/NonPromptWT/JPsi/0_1.4/NonPromptWTJPsi0_1.4_eff_comb.root";
  const char* inputFile2 = "./rootFile/NonPromptWT/JPsi/1.4_2.4/NonPromptWTJPsi1.4_2.4_eff_comb.root";
  const char* inputFile3 = "./rootFile/NonPromptWT/Psi2S/0_1.4/NonPromptWTPsi2S0_1.4_eff_comb.root";
  const char* inputFile4 = "./rootFile/NonPromptWT/Psi2S/1.4_2.4/NonPromptWTPsi2S1.4_2.4_eff_comb.root";
  const char* title = "NonPromptWTPsi_over_JPsi_canvas";
  const char* outputFile = "NonPromptWTPsi_over_JPsi_canvas.png";
  int n1 = 2;
